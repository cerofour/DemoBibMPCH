...
CREATE TABLE IF NOT EXISTS tipos_textos (
...
CREATE TABLE IF NOT EXISTS registros_accesos_administradores (
...
CREATE TABLE IF NOT EXISTS registros_accesos_clientes (
